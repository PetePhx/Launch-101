...
calc_mesg[:en] = {welcome: "Welcome to Calculator! Enter your name:",
                 hi: "Hi ",
...
calc_mesg[:fr] = {welcome: "Bienvenue à Calculator! Entrez votre nom: ",
                  ...
                  further_calc:
                  "Voulez-vous effectuer un autre calcul? (Y pour calculer à nouveau) ",
                  kthnxbye: "Merci d'avoir utilisé la calculatrice. Au revoir!",
                  op_verbs: %w(Ajout Soustraire Multiplication Diviser)
                 }

calc_mesg[:de] = {welcome: "Willkommen bei Calculator! Geben Sie Ihren Namen ein:",
                  hi: "Hallo ",
                  name_err: "Stellen Sie sicher, dass Sie einen gültigen Namen verwenden",
                  ...
                  further_calc:
                  "Möchten Sie eine weitere Berechnung durchführen? (Y, um wieder zu berechnen)",
                  kthnxbye: "Vielen Dank für die Verwendung des Rechners. Auf wieder sehen!",
